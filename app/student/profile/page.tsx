...
export default function StudentProfilePage() {
  ...
  // Track locally so uploader reflects changes immediately
        ...
        <div className="bg-white border border-[#c8b89a] rounded-sm shadow-[3px_3px_0_#c8b89a] overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-5">
            ...
            <button
              type="submit"
              disabled={saving}
              className="w-full py-3 bg-[#1a2535] text-[#63b3ed] text-sm font-semibold rounded-sm
                         border border-[rgba(99,179,237,0.3)] hover:bg-[#243040] disabled:opacity-50
                         transition-colors shadow-[2px_2px_0_rgba(26,37,53,0.4)]"
            >
