...
import {
  IconHome, IconSubjects, IconProjects,
  IconAnnouncements, IconClassmates, IconProfile,
  ...
  return (
    ...
    >
      ...
      {avatarPopup && (
        ...
        >
          <div
            className="bg-[#1a2535] border border-[rgba(99,179,237,0.2)] rounded-sm shadow-[6px_6px_0_rgba(0,0,0,0.4)] p-6 w-72 flex flex-col items-center gap-4"
          ...
          >
            ...
            <div className="text-center">
              ...
              <div className="text-[#63b3ed] text-[10px] font-mono tracking-widest uppercase mt-0.5">
                Student
              </div>
            ...
            <div className="flex gap-2 w-full pt-1">
              <Link
                ...
                onClick={() => setAvatarPopup(false)}
                className="flex-1 text-center text-xs py-2 border border-[rgba(99,179,237,0.3)] text-[#63b3ed]
                           hover:bg-[rgba(99,179,237,0.1)] rounded-sm font-mono transition-colors"
              >
                Edit Profile
              </Link>
              <button
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className={`text-sm font-semibold truncate ${active ? "text-[#63b3ed]" : "text-[rgba(250,246,238,0.6)]"}`}
        ...
        <div className="p-4 border-t border-[rgba(212,168,67,0.1)]">
          ...
          <button
            ...
            className="w-full flex items-center gap-3 mb-3 px-2 py-2 rounded-sm
                       hover:bg-[rgba(99,179,237,0.08)] transition-colors group"
          >
            <Avatar
              src={avatarUrl}
              name={session?.user?.name}
            ...
            <svg width="12" height="12" viewBox="0 0 12 12" fill="none"
              ...
              <path d="M4 5l2 2 2-2" stroke="#63b3ed" strokeWidth="1.5" strokeLinecap="round"/>
            </svg>
          </button>
        ...
        <header className="lg:hidden sticky top-0 z-30 flex items-center justify-between px-4 py-3 bg-[#1a2535] border-b border-[rgba(99,179,237,0.15)]">
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={() => setAvatarPopup(true)}>
              <Avatar src={avatarUrl} name={session?.user?.name} role="student" size={30} />
            </button>
