...
interface Report {
  ...
  summary: {
    ...
    totalProjects: number; avgGrade: number | null
    totalSubmissions: number; gradedSubmissions: number; lateSubmissions: number
  }
  subjects: any[]
  remarks: string
}
            ...
            {!selected ? (
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white border border-[#c8b89a] rounded-sm p-4 shadow-[2px_2px_0_#c8b89a]">
                  <h3 className="text-xs font-mono text-[#7a6a52] uppercase tracking-wider mb-3">Submission Statistics</h3>
                  <div className="grid grid-cols-3 gap-4">
                    {[
                      { label: 'Total Submissions', value: selected.summary.totalSubmissions,  color: 'text-[#1a1209]' },
                      { label: 'Graded',            value: selected.summary.gradedSubmissions, color: 'text-[#1a7a6e]' },
                      { label: 'Late',              value: selected.summary.lateSubmissions,   color: 'text-[#c0392b]' },
                    ].map(s => (
