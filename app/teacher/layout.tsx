...
export default function TeacherLayout({
  ...
  return (
    ...
    >
      ...
      {/* SIDEBAR */}
      <aside
        className={`fixed top-0 left-0 h-full min-h-screen w-64 z-50 flex flex-col bg-[#1a3a2a] border-r border-[rgba(26,122,110,0.2)] transition-transform duration-300 ${mobileOpen ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0 lg:sticky lg:z-auto`}
      >
        {/* Logo */}
        ...
        <div className="p-4 border-t border-[rgba(26,122,110,0.15)]">
          <div className="flex items-center gap-3 mb-3 px-2">
            <div
              className="w-8 h-8 rounded-sm bg-[rgba(26,122,110,0.2)] border border-[rgba(26,122,110,0.35)] flex items-center justify-center text-sm font-bold"
              style={{ color: "#88d4ab" }}
            >
