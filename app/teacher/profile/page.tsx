...
export default function TeacherProfilePage() {
  ...
  // Track locally so the uploader card reflects changes immediately
    ...
    <div>
      ...
      <div className="max-w-lg space-y-4">
        ...
        <div className="bg-white border border-[#c8b89a] rounded-sm p-6 shadow-[3px_3px_0_#c8b89a]">
          ...
          <AvatarUploader
            ...
            onUpload={(url) => {
              ...
              update() // refresh session so sidebar avatar updates too
            }}
          />
        </div>
        ...
        <div className="bg-white border border-[#c8b89a] rounded-sm p-5 shadow-[2px_2px_0_#c8b89a]">
          <div className="font-bold text-[#1a1209] text-lg" style={{ fontFamily: 'Georgia, serif' }}>
            {session?.user?.name}
          </div>
          <div className="text-xs font-mono text-[#1a7a6e] bg-[rgba(26,122,110,0.08)] border border-[rgba(26,122,110,0.25)] px-2 py-0.5 rounded-sm inline-block mt-1">
            Teacher
          </div>
        ...
        <div className="bg-white border border-[#c8b89a] rounded-sm shadow-[3px_3px_0_#c8b89a] overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-5">
            ...
            <button
              type="submit"
              disabled={saving}
              className="w-full py-3 bg-[#1a3a2a] text-[#d4a843] text-sm font-semibold rounded-sm
                         border border-[rgba(212,168,67,0.3)] hover:bg-[#224d38] disabled:opacity-50
