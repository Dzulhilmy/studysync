    ...
    <div>
      ...
      <div className="max-w-lg">
        ...
        <div className="bg-white border border-[#c8b89a] rounded-sm p-6 shadow-[3px_3px_0_#c8b89a] mb-6 flex items-center gap-5">
          <div className="w-16 h-16 rounded-sm bg-[#1a3a2a] border-2 border-[rgba(26,122,110,0.4)] flex items-center justify-center text-2xl font-bold text-[#d4a843]">
            {session?.user?.name?.[0] ?? 'T'}
          </div>
          <div>
            <div className="font-bold text-[#1a1209] text-lg" style={{ fontFamily: 'Georgia, serif' }}>{session?.user?.name}</div>
            <div className="text-xs font-mono text-[#1a7a6e] bg-[rgba(26,122,110,0.08)] border border-[rgba(26,122,110,0.25)] px-2 py-0.5 rounded-sm inline-block mt-1">Teacher</div>
        ...
        <div className="bg-white border border-[#c8b89a] rounded-sm shadow-[3px_3px_0_#c8b89a] overflow-hidden">
          <div className="bg-[#f0e9d6] border-b border-[#c8b89a] px-6 py-3">
            <h2 className="font-bold text-[#1a1209]" style={{ fontFamily: 'Georgia, serif' }}>Edit Profile</h2>
          </div>
          <form onSubmit={handleSubmit} className="p-6 space-y-5">
            ...
            <div className="border-t border-[#f0e9d6] pt-4">
              <p className="text-xs font-mono text-[#7a6a52] uppercase tracking-wider mb-4">Change Password <span className="normal-case">(leave blank to keep current)</span></p>
            ...
            <button type="submit" disabled={saving}
              className="w-full py-3 bg-[#1a3a2a] text-[#d4a843] text-sm font-semibold rounded-sm border border-[rgba(212,168,67,0.3)] hover:bg-[#224d38] disabled:opacity-50 transition-colors shadow-[2px_2px_0_rgba(26,18,9,0.3)]">
